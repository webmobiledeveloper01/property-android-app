...
function Laundry({ title, id, item, cancelLaundryRoom }) {
    ...
    return (
        ...
        <Column noPadding size={1}>
            ...
            {renderWallItem(title = 'Walls', id = '2')}
            {renderDoorItem(title = 'Tubs', id = '3')}
            {renderCeilingItem(title = 'Floor waste', id = '4')}
            {renderBenchtopItem(title = 'CeDooriling', id = '5')}
            {renderTapsItem(title = 'Window', id = '6')}
            {renderPictures()}
        </View>
    );
}
